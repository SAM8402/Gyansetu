<template>
  <div>
    ...
    <div v-else class="border border-gray-200 rounded-lg overflow-hidden">
      <div v-for="job in jobs" :key="job.id" class="flex items-center justify-between px-5 py-3.5 border-b border-gray-100 last:border-b-0 cursor-pointer hover:bg-gray-50 transition" @click="$router.push(`/results/${job.id}`)">
